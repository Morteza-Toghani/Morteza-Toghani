...
<table>
  <tr>
    <td width="30%"><b><a href="https://github.com/Morteza-Toghani/ua-mobile-manip">ua-mobile-manip</a></b></td>
    <td>Hybrid online/offline RL framework combining online uncertainty estimation with multi-modal perception for real-world mobile manipulation.<br/><sub><b>Stack:</b> PyTorch · MuJoCo · robosuite · ROS</sub></td>
  </tr>
  <tr>
    <td width="30%"><b><a href="https://github.com/Morteza-Toghani/cr-mobile-manip">cr-mobile-manip</a></b></td>
    <td>Bayesian/ensemble uncertainty layer as an online exploration signal for sample-efficient RL in contact-rich mobile manipulation tasks.<br/><sub><b>Stack:</b> PyTorch · MuJoCo · Python · NumPy</sub></td>
  </tr>
</table>
...
<p>
  ...
  <img src="https://img.shields.io/badge/MuJoCo-4B8224?style=flat-square&logo=google&logoColor=white" />
...
<p align="center"><i>Open to research internships and PhD positions in embodied AI, robot learning, and uncertainty-aware RL.</i></p>
