...
To operate reliably outside structured factory setups, my work combines multi-modal perception—fusing vision, tactile feedback, and proprioception—with hybrid online/offline learning paradigms. By explicit modeling of physical and sensory uncertainty during policy execution, the goal is to build physical AI systems that remain provably robust, sample-efficient, and safe during real-robot deployment.
...
![MuJoCo](https://img.shields.io/badge/MuJoCo-4B8224?style=flat-square&logo=google&logoColor=white)
...
* Finalizing benchmarking, empirical ablation studies, and manuscript writing for ICRA/IROS submission.

---

*Open to research internships and PhD positions in embodied AI, robot learning, and uncertainty-aware RL.*
